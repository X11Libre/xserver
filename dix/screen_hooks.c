...
void dixScreenRaiseDisplayCursor(ScreenPtr pScreen, DeviceIntPtr pDev, CursorPtr pCursor)
{
    /* fow now just calling the screen proc, but in the future we'll also handle hide
