...
#define EXTENSION_MAJOR_XF86_DGA            (EXTENSION_BASE + 24)
#define EXTENSION_MAJOR_XF86_DRI            (EXTENSION_BASE + 25)
#define EXTENSION_MAJOR_XF86_VIDMODE        (EXTENSION_BASE + 26)
#define EXTENSION_MAJOR_XC_MISC             (EXTENSION_BASE + 27)
#define EXTENSION_MAJOR_XINPUT              (EXTENSION_BASE + 28)
#define EXTENSION_MAJOR_XINERAMA            (EXTENSION_BASE + 29)
#define EXTENSION_MAJOR_XKEYBOARD           (EXTENSION_BASE + 30)
#define EXTENSION_MAJOR_XRESOURCE           (EXTENSION_BASE + 31)
#define EXTENSION_MAJOR_XTEST               (EXTENSION_BASE + 32)
#define EXTENSION_MAJOR_XVIDEO              (EXTENSION_BASE + 33)
#define EXTENSION_MAJOR_XVMC                (EXTENSION_BASE + 34)

#define RESERVED_EXTENSIONS                 37
