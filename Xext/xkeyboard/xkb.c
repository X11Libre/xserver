...
ProcXkbGetMap(ClientPtr client)
{
    ...
    XkbAssembleMap(client, xkb, reply.firstType, reply.nTypes, reply.firstKeySym,
                   reply.nKeySyms, reply.firstKeyAct, reply.nKeyActs, reply.firstKeyBehavior,
                   reply.nKeyBehaviors, reply.virtualMods, reply.firstKeyExplicit,
                   reply.nKeyExplicit, reply.firstModMapKey, reply.nModMapKeys,
                   reply.firstVModMapKey, reply.nVModMapKeys, reply.totalKeyBehaviors,
                   reply.totalKeyExplicit, reply.totalModMapKeys, reply.totalVModMapKeys, &rpcbuf);
...
ProcXkbGetKbdByName(ClientPtr client)
{
    ...
    if (reported & (XkbGBN_SymbolsMask | XkbGBN_TypesMask)) {
        ...
        XkbAssembleMap(client, new, mrep.firstType, mrep.nTypes, mrep.firstKeySym,
                       ...
                       mrep.totalKeyExplicit, mrep.totalModMapKeys, mrep.totalVModMapKeys, &childbuf);
