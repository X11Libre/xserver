...
xnestKeyboardProc(DeviceIntPtr pDev, int onoff)
{
    ...
    case DEVICE_INIT:
        ...
        xcb_get_modifier_mapping_cookie_t mod_cookie = xcb_get_modifier_mapping(
            xnestUpstreamInfo.conn);

        xcb_generic_error_t *mod_err = NULL;
        xcb_get_modifier_mapping_reply_t *mod_reply = xcb_get_modifier_mapping_reply(
            xnestUpstreamInfo.conn, mod_cookie, &mod_err);
        ...
        xcb_xkb_get_controls_cookie_t cookie = xcb_xkb_get_controls(xnestUpstreamInfo.conn,
                                                                    device_id);
        xcb_generic_error_t *err = NULL;
        xcb_xkb_get_controls_reply_t *reply = xcb_xkb_get_controls_reply(xnestUpstreamInfo.conn,
                                                                         cookie,
                                                                         &err);
        if (err) {
...
XkbError:
    xcb_get_keyboard_control_cookie_t ctrl_cookie =
