 ...
 * @file client.c
 *
 * This file contains X11 client identification code implemented specifically for Apple targets (macOS and earlier OSX versions, and possibly
 * other Apple targets if an X server can run on them).
 * Much of this code comes from os/client.c, but moved into a separate file to clean up the former.
 * This file is part of the XLibre project and provided under the same license.
 *
